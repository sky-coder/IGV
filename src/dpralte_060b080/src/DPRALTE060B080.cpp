...
{
    DPRALTE060B080::setConfigurationCommand(0xa5, 0x3e, 0x01, 0x07, 0x00, 0x01, 0x82, 0x6a);
    LeftPort.write(ConfigurationCommand, CFG_CMD_SIZE);
}
//----------------------------------------------------------------------- Right
...
{
    DPRALTE060B080::setConfigurationCommand(0xa5, 0x3f, 0x01, 0x07, 0x00, 0x01, 0x28, 0x3b);
    LeftPort.write(ConfigurationCommand, CFG_CMD_SIZE);
}
//============================================================================= Part 4
